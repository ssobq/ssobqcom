...
<body class="bg-light">
    ...
    <main class="container my-5">
        ...
        <div class="row mb-5 text-center">
            <div class="col-12">
                <h1 class="display-4 font-weight-bold" style="color: #004085; font-size: 2.8rem;">Nuestros Servicios</h1>
                <p class="lead text-muted mt-3">Soluciones integrales en Seguridad y Salud en el Trabajo para su empresa.</p>
