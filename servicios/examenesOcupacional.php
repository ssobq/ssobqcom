...
<head>
    ...
    <title>Exámenes Ocupacional | SSO</title>
</head>
...
<body>
    ...
    <div class="container" id="centerDiv">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="font-weight-bold text-center colorAzul">EXÁMENES OCUPACIONALES</h1>
            </div>
        </div>
        <br>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <img class="img-fluid rounded center " src="/img/servicios/examenOcupacional/examen-ocupacional-ssobq.jpg">
            </div>
        </div>
