...
<head>
    ...
    <style>
        ...
        /* Estilo interactivo para la lista del PESV */
        .pesv-list-item {
            display: flex;
            ...
            <div class="col-12 col-lg-7 mb-4 mb-lg-0 d-flex">
                <div class="card border-0 shadow-sm w-100 p-4 p-md-5" style="border-radius: 15px;">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <i class="fa-solid fa-road-circle-check fa-2x mr-3 text-corporate-red"></i>
                    ...
                    <div class="pesv-list-item">
                        ...
                        <span>Capacitación y Formación teórica en Seguridad Vial.</span>
                    </div>
                    <div class="pesv-list-item">
                    ...
                    <div class="pesv-list-item">
                        ...
                        <span>Examen médico para la Licencia de Conducción.</span>
                    </div>
                    <div class="pesv-list-item">
                        <i class="fa-solid fa-car-side"></i>
                        <span>Pruebas de Idoneidad teórico - prácticas (pericia).</span>
                    </div>
                    <div class="pesv-list-item">
                        <i class="fa-solid fa-shield-halved"></i>
                        <span>Cursos y estrategias de Manejo Defensivo.</span>
                    </div>
