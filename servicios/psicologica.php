...
<head>
    ...
    <title>Prueba psicológica | SSO</title>
</head>
...
<body>
    ...
    <div class="container" id="centerDiv">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="font-weight-bold text-center colorAzul">PRUEBAS PSICOLÓGICAS</h1>
            </div>
        </div>
        <br>
        <br>
        ...
        <section class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    <img alt="Silverfox" class="img-fluid" src="/img/servicios/psicologia/fondo.jpg">
                    <div class="caption">
                        <br>
                        <br>
