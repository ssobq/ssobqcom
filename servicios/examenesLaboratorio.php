...
<head>
    ...
    <title>Exámenes de laboratorio | SSO</title>
</head>
...
<body>
    ...
    <div class="container" id="centerDiv">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="font-weight-bold text-center colorAzul">EXÁMENES DE LABORATORIO</h1>
            </div>
        </div>
        <br>
        <br>
        <!-- FILA 2-->
        <div class="row justify-content-center h-100 fondo">
